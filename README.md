...
| **Game** | The poker table: practice, vs-bot, and networked 2-player over the P2P mesh. Texas Hold'em engine with blinds, all-in side pots, showdown, and chip conservation; six variants. |
...
dotnet/
  ...
  src/BsvPoker.Net/      P2P gossip mesh, networked 2-player game protocol, encrypted chat
...
- True cryptographic hole-card privacy (commutative-encryption mental poker, secp256k1-only).
