...
const FACTORIES: Record<Variant, (deck: readonly Card[]) => GenericGameModule> = {
  holdem: (deck) => createHoldem({ deck }) as unknown as GenericGameModule,
...
export function createGameModule(variant: Variant, deck: readonly Card[]): GenericGameModule {
