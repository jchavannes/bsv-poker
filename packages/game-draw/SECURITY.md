# `@bsv-poker/game-draw` — Security model

Five-card Draw (concealed cards + a discard/draw round). It is a **pure deterministic** game module: no network, no I/O, no time, no randomness.
