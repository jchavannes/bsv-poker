# `@bsv-poker/game-omaha` — Security model

Omaha / Omaha-8 (4 hole cards, use exactly 2); optional Hi-Lo split. It is a **pure deterministic** game module: no network, no I/O, no time, no randomness.
