# `@bsv-poker/game-blackjack` — Security model

Blackjack module (card values, ace 11/1) — house-banked variant scaffolding. It is a **pure deterministic** game module: no network, no I/O, no time, no randomness.
