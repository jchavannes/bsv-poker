# `@bsv-poker/game-holdem` — Security model

Texas Hold'em (2 hole cards, 5 community); the Phase-1 flagship variant. It is a **pure deterministic** game module: no network, no I/O, no time, no randomness.
