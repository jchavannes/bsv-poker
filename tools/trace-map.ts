...
export const TRACE_MAP: Readonly<Record<string, Trace>> = {
  ...
  'REQ-NET-004': { files: ['apps/indexer-go/indexer/indexer.go', 'packages/app-services/src/transcript.ts', 'packages/adapters/src/transaction-graph.ts', 'packages/sdk/src/canonical-indexer.ts', 'docs/adr/0005-indexer-is-a-projection-not-an-adjudicator.md'], tests: ['apps/indexer-go/indexer/indexer_test.go', 'packages/app-services/test/transcript-legality.test.ts', 'packages/adapters/test/transaction-graph.test.ts', 'packages/sdk/test/canonical-indexer.test.ts'] },
