...
export const TRACE_MAP: Readonly<Record<string, Trace>> = {
  ...
  'REQ-NET-001': { files: ['packages/adapters/src/p2p-transport.ts'], tests: ['packages/adapters/test/p2p-transport.test.ts'] },
  ...
  'REQ-NET-004': { files: ['packages/app-services/src/transcript.ts', 'packages/adapters/src/transaction-graph.ts', 'packages/sdk/src/canonical-indexer.ts', 'docs/adr/0005-indexer-is-a-projection-not-an-adjudicator.md'], tests: ['packages/app-services/test/transcript-legality.test.ts', 'packages/adapters/test/transaction-graph.test.ts', 'packages/sdk/test/canonical-indexer.test.ts'] },
  ...
  'REQ-NET-006': { files: ['packages/app-services/src/transcript.ts'], tests: ['packages/app-services/test/transcript-legality.test.ts'] },
  'REQ-NET-007': { files: ['packages/app-services/src/transcript.ts'], tests: ['packages/app-services/test/transcript-legality.test.ts'] },
  'REQ-PROD-011': { files: ['packages/app-services/src/transcript.ts'], tests: ['packages/app-services/test/transcript-legality.test.ts'] },
  ...
  'REQ-APP-070': { files: ['packages/app-services/src/network.ts', 'packages/adapters/src/p2p-transport.ts'], tests: ['packages/adapters/test/p2p-transport.test.ts'] },
